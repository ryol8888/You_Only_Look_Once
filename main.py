...
parser.add_argument('--datalist_path', type=str, help='path to use dataset list to train', required=False, default="C:\Dataset\VOCdevkit\VOC2007/ImageSets/Main/train.txt")
