...
parser.add_argument('--data_path', type=str, help='path to the data', default='D:/Dataset/VOCdevkit/VOC2007', required=True)
parser.add_argument('--datalist_path', type=str, help='path to use dataset list to train', required=False, default="D:/Dataset/VOCdevkit/VOC2007/ImageSets/Main/train.txt")
